...
saveRDS(results, 
        file = paste0("output/draws/structural_pre_train/", upcoming_election, "_structural_pre_train_stan_simple.RDS"))
...
saveRDS(structural_forecast, 
        file = paste0("output/forecasts/Structural/", upcoming_election, "_structural_forecast_simple.RDS"))
...
saveRDS(structural_inits, file = paste0("data/structural_inits/", upcoming_election, "_structural_inits_simple.RDS"))
